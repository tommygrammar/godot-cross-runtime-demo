#utilities
from metadata import argument_types, return_types, forced_return_type_by_method, cpp_keywords, cs_keywords, cpp_local_reserved,cs_local_reserved 
import json
import re

# takes a raw identiier and normalizes it. the language determins keyword ruls
